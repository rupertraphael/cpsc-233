...
public class FlightTest {
	...
	// Testing constructors
		...
		public void testConstructor_departureSameAsArrival(){
			...
			assertEquals("testing departure", expectedDeparture, c.getDeparture());
		...
		public void testConstructor_departureAfterArrival(){
			...
			Date expectedArrival = null;
			assertEquals("Departure one minute after arrival, testing departure", expectedDeparture, c.getDeparture());
