...
public class NonProjectCategory extends Category {
	...
	public ArrayList<Double> dropGrades()
	{
		...
		for(int itemCounter = 0; itemCounter < super.grades.size(); itemCounter++)
		{
			droppedList.add(new Double(super.grades.get(itemCounter)));
		}
		
		int dropCounter = 0;
		while((this.numDroppedGrades <= super.grades.size()) && (dropCounter < this.numDroppedGrades))
		{
			int minIndex = 0;		
